...
# *Note* np.sctypes -> np.core.sctypes since numpy 2.0
try:
    _npsctypes = np.core.sctypes
except Exception:
    _npsctypes = np.sctypes
NP_FLOAT_TYPES = set(_npsctypes["float"])
NP_INT_TYPES = set(_npsctypes["int"])
NP_UINT_TYPES = set(_npsctypes["uint"])
